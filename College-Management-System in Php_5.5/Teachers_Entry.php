...
$sql_ins=mysqli_query($link,"INSERT INTO teacher_tbl 
						VALUES(
							NULL,
							'$f_name',
							'$l_name' ,
...
$sql_update=mysqli_query($link,"UPDATE teacher_tbl SET
                        f_name='$f_name' ,
                        l_name='$l_name' ,
                        gender='$gender' ,
                        dob='$dob' ,
...
if($opr=="upd")
{
	$sql_upd=mysqli_query($link,"SELECT * FROM teacher_tbl WHERE teacher_id=$id");
